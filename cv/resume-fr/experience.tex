...
{Canal Plus.} % Organisation
{Paris, France} % Lieu
{Août 2022 - Déc. 2022} % Dates
{
  \begin{cvitems} % Description(s) des tâches/responsabilités
...
%---------------------------------------------------------
\cventry
{Technicien d'Exploitation, Administrateur systèmes} % Intitulé du poste
