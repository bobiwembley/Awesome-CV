...
{
  \begin{cvitems}
    \item {\textbf{Role:} membre de l"équipe Observability \& Monitoring.}
    ...
    \item {\textbf{Environnement:} Dynatrace, Ansible \& ansible-tower, Git, Jira, Jenkins, Artifactory, Service Now.}
    \item {Installation de l'agent Dynatrace sur des serveurs Linux et Windows, en utilisant Ansible pour l'automatisation.}
    \item {Maintien de la solution on premisse de Dynatrace, Elasticsearch \& Cassandra.  Mise en place du Backup \& Restauration des métriques datas. Mise place du backup \& restauration des configurations avec monaco (Monitoring As Code)}
    \item {support pour les équipe de développement pour l'instrumentation des applications pour la surveillance.}
